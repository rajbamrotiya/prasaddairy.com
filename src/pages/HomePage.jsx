                    ...
                    <div className="grid lg:grid-cols-2 gap-24">
                        <div>
                            ...
                            <p className="text-muted text-lg leading-relaxed">
                                We take pride in our sustainable practices and our role in supporting the local agricultural community. By providing fair prices and technical support to our farmers, we ensure a prosperous future for both the community and the environment. Our state-of-the-art processing facility allows us to maintain the nutritional integrity of our products while adhering to the highest safety standards. From our signature authentic Buffalo Ghee (Desi Ghee) to our creamy Malai Paneer and fresh milk, every product we craft is a testament to our dedication to excellence and our love for traditional dairy craftsmanship.
                            </p>
                        </div>
