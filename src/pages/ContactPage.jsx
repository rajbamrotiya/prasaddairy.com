            ...
            <section className="py-32 text-center bg-white">
                <div className="max-w-2xl mx-auto px-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        ...
                        <a 
                            href={`https://wa.me/+919426992952?text=${encodeURIComponent("Hello Prasad Dairy, I would like to inquire about bulk ordering and custom requirements. Please share more details.")}`}
                            target="_blank"
